export function renderCourseArabic(container) {
    container.innerHTML = `
        <div class="container fade-in" style="padding: 40px 0; max-width: 1400px;">
            ...
            <div class="glass-card" style="padding: 15px; border-radius: 24px; height: calc(100vh - 250px); display: flex; flex-direction: column; overflow: hidden; border: 1px solid rgba(249, 115, 22, 0.3); box-shadow: 0 15px 35px rgba(249, 115, 22, 0.15); background: rgba(255, 255, 255, 0.8);">
                <div id="course-frame-container" style="width: 100%; height: 100%; border-radius: 16px; overflow: hidden; background: white;">
                    <iframe style="width: 100%; height: 100%;" src="https://my.coursebox.ai/courses/223512/about" frameborder="0" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    `;
